...
if ( !contains( $_SERVER['HTTP_HOST'], array("127.0.0.1", "localhost", "192.168.") ) ) {
    if ( contain( $_SERVER['HTTP_HOST'], "stock.phoebelife.com" ) ) {
        header("location:".Gc::$url_base."index.php?go=stock.stock.index");
    } else {
        ...
        <div class="inbox">
            <div class="content-container">
                <div class="content" align="center">
                    ...
                    <p><a target="_blank" href="<?php echo Gc::$url_base?>index.php?go=mobile.index.index">手机应用</a></p>
                </div>
            </div>
        </div>
