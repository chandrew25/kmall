...
//        }
    ...
    if(!class_exists("SimpleXmlIterator")){echo "<p style='font: 15px/1.5em Arial;margin:15px;line-height:2em;'>没有安装simplexml模块支持,名称:php7.0-xml,如果是php7,请执行指令:sudo apt install php7.0-zip php7.0-xml<br/></p>";$is_not_run_betterlife=true;}
