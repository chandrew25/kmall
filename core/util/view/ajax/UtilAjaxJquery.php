...
class UtilAjaxJquery extends UtilAjax implements IUtilAjax
{
     ...
     */
    public static function loadReady($viewObject=null,$version="1.7.1"){
     ...
     * @param ViewObject $viewObject 表示层显示对象,只在Web框架中使用,一般结合loadJsReady使用
     */
    public static function load($version="1.7.1",$viewObject=null)
    {
        if (self::$IsGoogleApi){
            if (self::$IsDebug){
                if ($viewObject)
    ...
    public static function loadJqueryUI($viewObject=null,$version="1.8")
    {
        ...
        $ext_resource_root="jqueryui/";
        UtilCss::loadCssReady($viewObject,$ext_resource_root."jquery-ui.css",true,EnumJsFramework::JS_FW_JQUERY);
    }
