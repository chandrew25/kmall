...
class UtilEmailer
{
	 ...
	 * 邮件服务器域名
	 */
	private static $host="smtp.kmall-e.com";
	/**
	 * 邮件服务器端口
	 */
	 ...
	 * 用户名
	 */
	private static $username="sales@kmall-e.com";
	/**
	 * 密码
	 */
	private static $password="600602900901";
	/**
	 * 发件人地址
	 */
	private static $fromaddress="sales@kmall-e.com";
	/**
	 * 发送邮件
	 ...
	 */
	public static function sendEmail($fromname,$toaddress,$toname,$subject,$content) 
	{
		...
		$mail->From = self::$fromaddress; //邮件发送者email地址
