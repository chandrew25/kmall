    ...
    public static function thumb($image, $thumbname, $type = '', $maxWidth = 200, $maxHeight = 50, $interlace = true, $isStrict = false, $is_echo_output = false)
    {
        ...
        if ( $info !== false) {
            ...
            if ( $actualType != 'gif' && function_exists('imagecreatetruecolor') ) {
                ...
                if ( $actualType == 'png' ) self::setTransparency($thumbImg,$srcImg);
            } else {
            ...
            // 对jpeg图形设置隔行扫描
            if ( 'jpg' == $actualType || 'jpeg' == $actualType ) imageinterlace($thumbImg, $interlace);
            ...
            if ( 'jpg' == $actualType || 'jpeg' == $actualType ){
                ...
                if ($is_echo_output) $imageFun($thumbImg, null, 6);//默认6,压缩等级：0-9
