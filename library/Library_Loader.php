...
class Library_Loader
{
    ...
    {
        $dir_library_phpexcel="phpoffice" . DS . "phpexcel" . DS . "Classes" . DS;
        $class_phpexcel="PHPExcel.php";
        require_once(self::dir_library().$dir_library_phpexcel.$class_phpexcel);
        require_once(self::dir_library().$dir_library_phpexcel.'PHPExcel'.DIRECTORY_SEPARATOR.'Writer'.DIRECTORY_SEPARATOR.'Excel5.php');
