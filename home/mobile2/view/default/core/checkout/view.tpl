...
{block name=body}
    <div id="wrapper">
        ...
        <div class="m_pwd topline" style="height: auto;">
            <form action="{$url_base}index.php?go=mobile2.checkout.over" method="post" id="checkoverForm" >
            <div class="fill_order clearfix">
                <ul class="fill_box">
                    ...
                    <li class="fill_right fill_list fr">
                        <a href="{$url_base}index.php?go=mobile2.member.selAddress&location=checkout""><img src="{$template_url}resources/images/ddxq/right.png" class="fill_img" /></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="fill_main">
                ...
                <dl class="fill_dl clearfix">
                    ...
                    <dd class="fill_p_text fr">
                        ...
                        <span class="fill_int">￥{$cart->sales_price|string_format:'%.2f'}+{$cart->jifen}.0积分</span>
                    </dd>
                </dl>
                {/foreach}
            </div>
            <div class="con_sub clearfix">
                <span class="con_color fill_style fl all_style">实付款:{$statisticAll.realFee}{if $statisticAll.totalJifen}+{$statisticAll.totalJifen}积分{/if}</span>
