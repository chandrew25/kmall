        ...
        <div class="fill_order clearfix">
            <ul class="fill_box">
                {foreach item=address from=$addresses name=index}
                    <a class="fill_box" href="{$url_base}index.php?go=mobile2.member.checkouAddress&aid={$address->address_id}">
                    ...
                    <a class="fill_box" href="{$url_base}index.php?go=mobile2.member.addressupd&location=checkout&aid={$address->address_id}">
