    ...
    <div id="my">
        <div class="my_info">
            ...
            <div class="my_mian">
                ...
                <span class="my_txt">余额：{$member->jifen}积分</span>
            </div>
        </div>
        <div class="my_content clearfix">
            <ul>
                <a href="index.php?go=mobile2.order.lists">
                    <li class="my_border">
                ...
                <a href="/index.php?go=mobile2.member.results">
        ...
        <div id="close">
            <a href="index.php?go=mobile2.auth.logout" class="close_con">退出登录</a>
        </div>
