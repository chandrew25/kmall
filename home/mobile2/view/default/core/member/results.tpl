...
{block name=body}
    <div id="wrapper" class="m_pwd">
        ...
        <div class="int_title"><span class="int_pic"><a href="index.php?go=mobile2.member.view"><img src="{$template_url}resources/images/jifen/left.png"/></a></span>我的收货地址</div>
        <!--banner start-->
        <div class="fill_order clearfix">
            <ul class="fill_box">
                {foreach item=address from=$addresses name=index}
                <a class="fill_box" href="{$url_base}index.php?go=mobile2.member.addressupd&aid={$address->address_id}">
        ...
        <p class="new_ti">
            <a href="{$url_base}index.php?go=mobile2.member.address" class="add_bc">新增收货地址</a>
        </p>
        <!--menu  start-->
    </div>
    <!--menu  end-->
