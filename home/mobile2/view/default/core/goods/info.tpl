...
{block name=body}
	<div id="wrapper">
		...
		<div class="video details_back">
			<div class="deta_pic topline">
				...
				<p class="deta_con deta_line">￥{$product.price|string_format:'%.2f'}+{$product.jifen|string_format:'%d'}积分</p>
	...
	<div id="menu" class="detail_nav_main topline">
		<ul class="m_nav clearfix">
			...
			<a href="index.php?go=mobile2.checkout.view&id={$product.product_id}"><li class="m_nav_2 m_nav_fr ">立即购买</li></a>
		</ul>
	</div>
	<div id="back_top">
