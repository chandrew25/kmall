...
{block name=body}
	<div id="wrapper" class="m_pwd">
		...
		<div class="int_title"><span class="int_pic"><a href="index.php?go=mobile2.order.lists"><img src="{$template_url}resources/images/jifen/left.png"/></a></span>订单详情</div>
		...
		<div class="payment">
			...
			<p class="p_content topline">
				...
				<span class="p_c_txt">支付金额：￥{$orders->total_amount}+{$orders->jifen}积分</span>
