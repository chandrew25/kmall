...
{block name=body}
	<div id="wrapper" class="m_pwd">
		...
		<div class="int_title"><span class="int_pic"><a href="index.php?go=mobile2.member.view"><img src="{$template_url}resources/images/jifen/left.png"/></a></span>我的订单</div>
		<!--banner start-->
		...
		<div class="order">
			...
			<div class="order_btn topline clearfix">
				<p class="order_t_box clearfix fr">
					<a href="index.php?go=mobile2.order.info&id={$order->order_id}" class="p_money order_border order_style fl">订单详情</a>
					{if $order->pay_status==0}
					<a href="index.php?go=mobile2.checkout.show&order_id={$order->order_id}" class="p_money order_border  fr">付款</a>
					{else}
