 ...
 */
class ServiceMember extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:会员
    ...
    {
        return Member::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Member::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Member::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Member::get($filter,$sort,$limit);
    }
    ...
    {
        return Member::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Member::tablename(),Member::classname_static());
    }
}
?>