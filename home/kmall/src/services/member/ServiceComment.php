 ...
 */
class ServiceComment extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:会员评论
    ...
    {
        return Comment::deleteByIds($ids);
    }
    ...
    {
        return Comment::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Comment::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Comment::get($filter,$sort,$limit);
    }
    ...
    {
        return Comment::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Comment::tablename(),Comment::classname_static());
    }
    /**
     * 直接执行SQL语句
     * @return array
