 ...
 */
class ServiceAppdown extends Service implements IServiceBasic 
{
    /**
     * 保存数据对象:应用下载
    ...
    /**
     * 由标识删除指定ID数据对象 :应用下载
     * @param int $id 数据对象:应用下载标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Appdown::deleteByID($id);
    }
    ...
    {
        return Appdown::deleteByIds($ids);
    }
    ...
    {
        return Appdown::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Appdown::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Appdown::get($filter,$sort,$limit);
    }
    ...
    {
        return Appdown::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Appdown::tablename(),Appdown::classname_static());
    }
}
?>