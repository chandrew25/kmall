 ...
 */
class ServiceAttribute extends Service implements IServiceBasic 
{
    /**
     * 保存数据对象:属性表
    ...
    /**
     * 由标识删除指定ID数据对象 :属性表
     * @param int $id 数据对象:属性表标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Attribute::deleteByID($id);
    }
    ...
    {
        return Attribute::deleteByIds($ids);
    }
    ...
    {
        return Attribute::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Attribute::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Attribute::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Attribute::get($filter,$sort,$limit);
    }
    ...
    {
        return Attribute::get_one($filter,$sort);
    }
    ...
    {
        return Attribute::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Attribute::tablename(),Attribute::classname_static());
    }
}
?>