 ...
 */
class ServicePtypeattr extends Service implements IServiceBasic 
{
    /**
     * 保存数据对象:分类属性
    ...
    public function save($ptypeattr)
    {
        ...
        if ($ptypeattr instanceof Ptypeattr){
            return $ptypeattr->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :分类属性
     * @param int $id 数据对象:分类属性标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Ptypeattr::deleteByID($id);
    }
    ...
    {
        return Ptypeattr::deleteByIds($ids);
    }
    ...
    {
        return Ptypeattr::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Ptypeattr::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Ptypeattr::get($filter,$sort,$limit);
    }
    ...
    {
        return Ptypeattr::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Ptypeattr::tablename(),Ptypeattr::classname_static());
    }
}
?>