 ...
 */
class ServiceBulkpurchase extends Service implements IServiceBasic 
{
    /**
     * 保存数据对象:大宗采购
    ...
    public function save($bulkpurchase)
    {
        ...
        if ($bulkpurchase instanceof Bulkpurchase){
            return $bulkpurchase->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :大宗采购
     * @param int $id 数据对象:大宗采购标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Bulkpurchase::deleteByID($id);
    }
    ...
    {
        return Bulkpurchase::deleteByIds($ids);
    }
    ...
    {
        return Bulkpurchase::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Bulkpurchase::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Bulkpurchase::get($filter,$sort,$limit);
    }
    ...
    {
        return Bulkpurchase::get_by_id($id);
    }
    ...
    {
        return Bulkpurchase::count($filter);
    }
    ...
    {
        return Bulkpurchase::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Bulkpurchase::tablename(),Bulkpurchase::classname_static());
    }
}
?>