 ...
 */
class ServiceRefundcomment extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:退款评论
    ...
    public function save($refundcomment)
    {
        ...
        if ($refundcomment instanceof Refundcomment){
            return $refundcomment->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :退款评论
     * @param int $id 数据对象:退款评论标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Refundcomment::deleteByID($id);
    }
    ...
    {
        return Refundcomment::deleteByIds($ids);
    }
    ...
    {
        return Refundcomment::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Refundcomment::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Refundcomment::get($filter,$sort,$limit);
    }
    ...
    {
        return Refundcomment::get_by_id($id);
    }
    ...
    {
        return Refundcomment::count($filter);
    }
    ...
    {
        return Refundcomment::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Refundcomment::tablename(),Refundcomment::classname_static());
    }
}
?>