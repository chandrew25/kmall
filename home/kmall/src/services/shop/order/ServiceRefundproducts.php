 ...
 */
class ServiceRefundproducts extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:退款商品
    ...
    public function save($refundproducts)
    {
        ...
        if ($refundproducts instanceof Refundproducts){
            return $refundproducts->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :退款商品
     * @param int $id 数据对象:退款商品标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Refundproducts::deleteByID($id);
    }
    ...
    {
        return Refundproducts::deleteByIds($ids);
    }
    ...
    {
        return Refundproducts::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Refundproducts::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Refundproducts::get($filter,$sort,$limit);
    }
    ...
    {
        return Refundproducts::get_by_id($id);
    }
    ...
    {
        return Refundproducts::count($filter);
    }
    ...
    {
        return Refundproducts::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
     ...
     *
     * Refundproducts::classname_static()
     */
    public function sqlExecute($filter,$table)
    {
        return self::dao()->sqlExecute($filter,$table);
    }
}
?>