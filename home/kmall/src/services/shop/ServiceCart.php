 ...
 */
class ServiceCart extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:购物车
     * @param array|DataObject $cart
    ...
    {
        return Cart::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Cart::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Cart::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Cart::get($filter,$sort,$limit);
    }
    ...
    {
        return self::dao()->sqlExecute("select * from ".Cart::tablename(),Cart::classname_static());
    }
    ...
    {
        return self::dao()->sqlExecute("delete from ".Cart::tablename(),Cart::classname_static());
    }
}
?>