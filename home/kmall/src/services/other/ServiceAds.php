 ...
 */
class ServiceAds extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:广告
    ...
    {
        return Ads::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Ads::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Ads::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Ads::get($filter,$sort,$limit);
    }
    ...
    {
        return Ads::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Ads::tablename(),Ads::classname_static());
    }
}
?>