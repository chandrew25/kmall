 ...
 */
class ServiceMagazine extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:易乐杂志
     * @param array|DataObject $magazine
    ...
    /**
     * 由标识删除指定ID数据对象 :易乐杂志
     * @param int $id 数据对象:易乐杂志标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Magazine::deleteByID($id);
    }

    /**
     * 根据主键删除数据对象:易乐杂志的多条数据记录
    ...
    {
        return Magazine::deleteByIds($ids);
    }
    ...
    {
        return Magazine::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Magazine::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Magazine::get($filter,$sort,$limit);
    }
     ...
     * 3.允许对象如new User(id="1",name="green");<br/>
     * 默认:SQL Where条件子语句。如："(id=1 and name='sky') or (name like 'sky')"<br/>
     * @return 单个数据对象:易乐杂志实体
     */
    public function get_one($filter=null)
    {
        return Magazine::get_one($filter);
    }
    ...
    {
        return self::dao()->sqlExecute("select * from ".Magazine::tablename(),Magazine::classname_static());
    }
}
?>