 ...
 */
class ServiceSeriesimg extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:商品图片
    ...
    {
        if (is_array($seriesimg)){
            $seriesimg=new Seriesimg($seriesimg);
        }
        if ($seriesimg instanceof Seriesimg){
            return $seriesimg->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :商品图片
     * @param int $id 数据对象:商品图片标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Seriesimg::deleteByID($id);
    }
    ...
    {
        return Seriesimg::deleteByIds($ids);
    }
    ...
    {
        return Seriesimg::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Seriesimg::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Seriesimg::get($filter,$sort,$limit);
    }
    ...
    {
        return Seriesimg::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Seriesimg::tablename(),Seriesimg::classname_static());
    }
}
?>