 ...
 */
class ServiceCptypeshow extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:商品显示
     * @param array|DataObject $cptypeshow
     * @return int 保存对象记录的ID标识号
     */
    public function save($cptypeshow)
    {
        if (is_array($cptypeshow)){
            $cptypeshow=new Cptypeshow($cptypeshow);
        }
        if ($cptypeshow instanceof Cptypeshow){
            return $cptypeshow->save();
        }else{
            return false;
        }
    }
     ...
     */
    public function update($cptypeshow)
    {
        if (is_array($cptypeshow)){
            $cptypeshow=new Cptypeshow($cptypeshow);
        }
        if ($cptypeshow instanceof Cptypeshow){
            return $cptypeshow->update();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :商品显示
     * @param int $id 数据对象:商品显示标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Cptypeshow::deleteByID($id);
    }
    ...
    {
        return Cptypeshow::deleteByIds($ids);
    }
    ...
    {
        return Cptypeshow::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Cptypeshow::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Cptypeshow::get($filter,$sort,$limit);
    }
    ...
    {
        return Cptypeshow::get_by_id($id);
    }
    ...
    {
        return Cptypeshow::count($filter);
    }
    ...
    {
        return Cptypeshow::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Cptypeshow::tablename(),Cptypeshow::classname_static());
    }
}
?>