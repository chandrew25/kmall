 ...
 */
class ServiceProduct extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:商品
    ...
    {
        return Product::deleteByIds($ids);
    }
    ...
    {
        return Product::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Product::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Product::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Product::get($filter,$sort,$limit);
    }
    ...
    {
        return self::dao()->sqlExecute("select * from ".Product::tablename(),Product::classname_static());
    }
}
?>