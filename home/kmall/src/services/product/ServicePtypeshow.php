 ...
 */
class ServicePtypeshow extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:商品显示
    ...
    {
        if (is_array($ptypeshow)){
            $ptypeshow=new Ptypeshow($ptypeshow);
        }
        if ($ptypeshow instanceof Ptypeshow){
            return $ptypeshow->save();
        }else{
            return false;
        }
    }
    ...
    {
        return Ptypeshow::deleteByID($id);
    }
    ...
    {
        return Ptypeshow::deleteByIds($ids);
    }
    ...
    {
        return Ptypeshow::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Ptypeshow::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Ptypeshow::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Ptypeshow::get($filter,$sort,$limit);
    }
    ...
    {
        return Ptypeshow::get_one($filter);
    }
    ...
    {
        return Ptypeshow::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Ptypeshow::tablename(),Ptypeshow::classname_static());
    }
}
?>