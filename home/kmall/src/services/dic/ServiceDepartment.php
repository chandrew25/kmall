 ...
 */
class ServiceDepartment extends Service implements IServiceBasic 
{
    /**
     * 保存数据对象:部门
    ...
    {
        return Department::deleteByIds($ids);
    }
    ...
    {
        return Department::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Department::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Department::select($columns,$filter,$sort,$limit);
    }
    ...
    {
        return Department::get($filter,$sort,$limit);
    }
    ...
    {
        return Department::get_one($filter,$sort);
    }
    ...
    {
        return Department::count($filter);
    }
    ...
    {
        return Department::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Department::tablename(),Department::classname_static());
    }
}
?>
