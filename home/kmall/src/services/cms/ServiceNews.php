 ...
 */
class ServiceNews extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:易乐新闻
    ...
    {
        return News::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return News::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return News::get($filter,$sort,$limit);
    }
    ...
    {
        return News::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".News::tablename(),News::classname_static());
    }
}
?>