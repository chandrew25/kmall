 ...
 */
class ServiceHelpcenter extends Service implements IServiceBasic
{
    /**
     * 保存数据对象:帮助中心
    ...
    public function save($helpcenter)
    {
        ...
        if ($helpcenter instanceof Helpcenter){
            return $helpcenter->save();
        }else{
            return false;
        }
    }
    ...
    /**
     * 由标识删除指定ID数据对象 :帮助中心
     * @param int $id 数据对象:帮助中心标识
     * @return boolen 是否删除成功；true为操作正常
     */
    public function deleteByID($id)
    {
        return Helpcenter::deleteByID($id);
    }
    ...
    {
        return Helpcenter::deleteByIds($ids);
    }
    ...
    {
        return Helpcenter::increment($filter,$property_name,$incre_value);
    }
    ...
    {
        return Helpcenter::decrement($filter,$property_name,$decre_value);
    }
    ...
    {
        return Helpcenter::get($filter,$sort,$limit);
    }
    ...
    {
        return Helpcenter::get_by_id($id);
    }
    ...
    {
        return Helpcenter::count($filter);
    }
    ...
    {
        return Helpcenter::queryPage($startPoint,$endPoint,$filter,$sort);
    }
    /**
     * 直接执行SQL语句
     * @return array
    ...
    {
        return self::dao()->sqlExecute("select * from ".Helpcenter::tablename(),Helpcenter::classname_static());
    }
}
?>