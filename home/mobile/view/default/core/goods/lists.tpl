			            ...
			            <div class="list_s">
				            ...
				            <div class="list_s_con">
					            ...
					            <div class="list_s_conct">
						            <span class="list_s_conct_red">￥{$item->sales_price|string_format:'%d'}</span>
                                    <span style="text-decoration:line-through;float:right;line-height:46px;margin-right:10px">￥{$item->market_price|string_format:'%d'}</span>
					            </div>
