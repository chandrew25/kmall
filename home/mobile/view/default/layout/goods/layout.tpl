...
<head>
	...
	<script type="text/javascript" src="{$template_url}resources/gzip.php?js={$template_url}js/fill_name.js" ></script>
...
<body style="-webkit-text-size-adjust: 100%!important;">
	<div id="wrapper">
		{include file="$templateDir/layout/goods/head.tpl"}
		{block name=body}{/block}
		{include file="$templateDir/layout/goods/foot.tpl"}
	</div>
	<div id="back_top">
