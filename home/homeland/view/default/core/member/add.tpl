...
<div class="container">
	...
	<form action="" method="post" id="memberFrm">
		<div class="address_list">
			...
			<div class="address_list_s address_list_sinput">
				<div class="address_list_sl">
					<div class="address_list_slin">卡号</div>
				</div>
				<div class="address_list_sr">
					{if $member->cardno}
					<input type="hidden" name="cardno" id="cardno"  value="{$member->cardno}">
					{$member->cardno}
			  		{else}
			  		<input type="text" name="cardno" id="cardno" placeholder="提示：请输入实体卡正面卡号">
			...
			<!-- <div class="address_list_s address_list_sinput">
				<div class="address_list_sl">
					<div class="address_list_slin">密码</div>
				</div>
				<div class="address_list_sr">
					<input type="password" name="password" id="password" placeholder="提示：请输入实体卡背面初始密码">
				</div>
			</div> -->
			...
			<div class="address_list_s address_list_sinput">
				...
				<div class="address_list_sr">
					<input type="hidden" name="gender" id="gender" value="{$member->sex}">
					{if $member->sex==1}
					<div class="sex">
		...
		<div class="bnt">
			<input type="button" class="commerce_commit_btn" value="确认提交" />
		</div>
	</form>
	</div>
