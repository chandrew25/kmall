...
$(function(){
  $("#btnSmsSend").click(function(){
      ...
      var smsSendUrlValidate="home/mobile/src/httpdata/checkUsername.php?username="+username;
      $.get(smsSendUrlValidate, function(response){
          if (response==""){
          		$("#message").html("账户错误或未绑定手机号");
          } else {
            	settime();
            	var smsSendUrl="home/mobile/src/httpdata/smsSend.php?mobile="+response;
      			$.get(smsSendUrl);
          }
      });
  ...
  $("#smsPwd").keyup(function(){
	...
	$("#smsPwd").blur(function(){
      ...
      var username = $("#username").val();
      var smsSendUrlValidate="home/mobile/src/httpdata/smsSendValidate.php?smsPwd="+smsPwd+"&username="+username;
      $.get(smsSendUrlValidate, function(response){
          if (response=="1"){
