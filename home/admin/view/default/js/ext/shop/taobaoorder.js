Ext.namespace("Kmall.Admin.Taobaoorder");
Km = Kmall.Admin;
Km.Order={
	/**
	 * 全局配置
...
Km.Order.View = {
	...
	Grid:Ext.extend(Ext.grid.GridPanel, {
		...
		doSelectOrder : function() {
			...
			ExtServiceTaobaoorder.queryPageOrder(condition,function(provider, response) {   
...
Ext.onReady(function(){
	...
	Km.Order.Store.orderStore.proxy=new Ext.data.DirectProxy({ 
		api: {read:ExtServiceTaobaoorder.queryPageOrder}
	});
