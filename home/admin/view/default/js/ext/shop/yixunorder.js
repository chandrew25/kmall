Ext.namespace("Kmall.Admin.Yixunorder");
Km = Kmall.Admin;
Km.Order={
	/**
	 * 全局配置
...
Km.Order.View = {
	...
	Grid:Ext.extend(Ext.grid.GridPanel, {
		...
		doSelectOrder : function() {
			...
			ExtServiceYixunorder.queryPageOrder(condition,function(provider, response) {   
...
Ext.onReady(function(){
	...
	Km.Order.Store.orderStore.proxy=new Ext.data.DirectProxy({ 
		api: {read:ExtServiceYixunorder.queryPageOrder}
	});
