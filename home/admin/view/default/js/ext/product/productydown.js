...
Km.Product.View={
              ...
              {xtype: 'hidden',name : 'ptype_id',ref:'../ptype_id'},
              {
                ...
                items: [
                {
                  fieldLabel:"商品分类(<font color=red>*</font>):",xtype:'combotree', ref:'ptype_name',name: 'ptype_name',grid:this,
                        emptyText: '请选择商品分类',canFolderSelect:false,flex:2,editable:false,
                    ...
                    {title: '基本信息',ref:'tabProductDetail',iconCls:'tabs',
                     tpl: [
                         '<table class="viewdoblock">',
                           ...
                           '<tr class="entry"><td class="head">商品分类</td><td class="content">{ptype_name}</td></tr>',
                           ...
                           '<tr class="entry"><td class="head">商品图片</td><td class="content"><img src="upload/images/{image}" /></td></tr>',
                           '<tr class="entry"><td class="head">超大图片路径</td><td class="content">{image_large}</td></tr>',
                           '<tr class="entry"><td class="head">超大图片</td><td class="content"><img src="upload/images/{image_large}" /></td></tr>',
    ...
    Grid:Ext.extend(Ext.grid.GridPanel, {
        constructor : function(config) {
            ...
            {header : '排序',dataIndex : 'sort_order'}
                ...
                tbar : {
                  ...
                  text : '商品重新上架',ref: '../../btnUp',iconCls : 'icon-edit',disabled : true,
                  handler : function() {
                    this.upProduct();
                  }
                },'-',{
        ...
        sm : new Ext.grid.CheckboxSelectionModel({
            ...
            listeners : {
                selectionchange:function(sm) {
                    ...
                    this.grid.btnUp.setDisabled(sm.getCount() < 1);
                },
        ...
        doSelectProduct : function() {
            ...
            ExtServiceProduct.queryPageProductYdown(condition,function(provider, response) {
        ...
        addProduct : function() {
            ...
            Km.Product.View.Running.edit_window.setTitle('添加商品');
            Km.Product.View.Running.edit_window.savetype=0;
            Km.Product.View.Running.edit_window.product_id.setValue("");
            //Km.Product.View.Running.edit_window.imageUpload.setValue("");
            Km.Product.View.Running.edit_window.image_largeUpload.setValue("");
            switch (Km.Product.Config.OnlineEditor)
            {
                case 2:
        ...
        updateProduct : function() {
            ...
            Km.Product.View.Running.edit_window.setTitle('修改商品');
    ...
    */
    upProduct:function(){
      Ext.Msg.confirm('提示', '确实要重新上架所选的商品吗?',function(btn){
        if(btn=="yes"){
          var product_ids ="";
          ...
          ExtServiceProduct.productUp(product_ids,function(){
            Ext.Msg.alert("提示", "上架成功！");
            Km.Product.View.Running.productGrid.doSelectProduct();
          });
        }
      });
...
Ext.onReady(function(){
    ...
    Km.Product.Store.productStore.proxy=new Ext.data.DirectProxy({
        api: {read:ExtServiceProduct.queryPageProductYdown}
    });
    /**
     * 商品页面布局
     */
